// Auto-generated shim — re-exports from @/lib/goethe-zertifikat/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _goethe_zertifikat_Config } from "@/lib/goethe-zertifikat/config";
import { EXAM_CONFIG as _raw } from "@/lib/goethe-zertifikat/config";
