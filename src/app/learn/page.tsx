...
export const metadata: Metadata = {
  title: "Learn — Goethe-Zertifikat Practice",
  description: "Study and practice for Goethe-Zertifikat. Choose your subject and start preparing.",
};
