...
export const metadata: Metadata = {
  title: "Pricing — Goethe Zertifikat Premium",
  description: "Unlock unlimited Goethe Zertifikat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=goethe-zertifikat&cadence=annual`;
