...
import { EXAM_CONFIG } from "@/lib/goethe-zertifikat/config";

describe("Goethe-Zertifikat Config", () => {
  it("has correct exam ID", () => { expect(EXAM_CONFIG.examId).toBe("EXAM024"); });
  ...
  it("has correct URL", () => { expect(EXAM_CONFIG.url).toBe("https://goethe-zertifikat.koydo.app"); });
